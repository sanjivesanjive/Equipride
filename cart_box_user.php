...
<div id="ec-side-cart" class="ec-side-cart">
    ...
    if (mysqli_num_rows($cart_box) > 0) {
        ...
        while ($c = mysqli_fetch_array($cart_box)) {
            ...
            ?>
            <li>
            <a href="product_details_user.php?id=<?php echo $c['product_id'] ?>&product_id=<?php echo $c['pro_id'] ?>" class="sidecart_pro_img">
                                <img src="admin/file/<?php echo $c['s_image'] ?>" alt="product">
                            </a>
                            <div class="ec-pro-content">
                                <a href="product_details_user.php?id=<?php echo $c['product_id'] ?>&product_id=<?php echo $c['pro_id'] ?>" class="cart_pro_title">
                                    <?php echo $c['p_name'] ?>
                                </a>
...
if (!empty($productDetails)) {
    ...
    ?>
    <div class="cart_btn">
        <a href="cart_user.php?id=<?php echo $firstProduct['product_id'] ?>&product_id=<?php echo $firstProduct['pro_id']?>" class="btn btn-primary" style="margin: 25px 0px 0px 100px;">View Cart</a>
    </div>
    <?php
}
?>
