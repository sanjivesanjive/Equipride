                ...
                <div class="row align-items-center">
                    ...
                    <div class="col header-top-right d-none d-lg-block">
                        ...
                        <!-- Ec Header Search End -->
                            ...
                            <div id="google_translate_user"></div>
                                <script type="text/javascript">
                                function googleTranslateElementInit() {
                                new google.translate.TranslateElement({pageLanguage: 'en'}, 'google_translate_user');
                                }
                                </script>
                        ...
                        <div class="ec-header-bottons">
                            ...
                            <div class="ec-header-user dropdown">
                                ...
                                session_start();
                                        ...
                                        $guest =mysqli_query($con,"SELECT * FROM `register` WHERE `userid` = '$userid'") or die(mysqli_error($con));
                            ...
                            <a href="wishlist_user.php" class="ec-header-btn ec-header-wishlist" id="wishlist-link">
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="user_panal.php"><img src="images/Logo editted.png" alt="Site Logo" /><img
...
<div id="ec-main-menu-desk" class="d-none d-lg-block sticky-nav">
        ...
        <ul class="mega-menu d-block" style="position: absolute; width: 305%; left: -100%;">
            <li class="d-flex">
                ...
                if (mysqli_num_rows($rider) > 0) {
                    while ($r = mysqli_fetch_assoc($rider)) {
                        ?>
                        <ul class="d-block">
                            ...
                            if (mysqli_num_rows($query1) > 0) {
                                while ($q1 = mysqli_fetch_assoc($query1)) {
                                    ?>
                                    <li><a href="category_user.php?subcategory=<?php echo $q1['sub_category'] ?>"><?php echo $q1['sub_category'] ?></a></li>
                                <?php }} ?>
                        </ul>
                <?php }} ?>
            </li>
        ...
        <ul class="mega-menu d-block" style="position: absolute; width: 305%; left: -100%;">
            <li class="d-flex">
                ...
                if (mysqli_num_rows($horse) > 0) {
                    while ($r = mysqli_fetch_assoc($horse)) {
                        ?>
                        <ul class="d-block">
                            <li class="menu_title"><a href="javascript:void(0)"><?php echo $r['category'] ?></a></li>
                            <?php $category_id = $r['id'];
    ...
    <li class="dropdown position-static"><a href="javascript:void(0)">DOG</a>
        <ul class="mega-menu d-block" style="position: absolute; width: 305%; left: -100%;">
            <li class="d-flex">
                <?php
                $dog = mysqli_query($con, "SELECT * FROM `category` WHERE `type`='Dog' AND `type_1` = 'Customer' ") or die(mysqli_error($con));
                if (mysqli_num_rows($dog) > 0) {
                    while ($r = mysqli_fetch_assoc($dog)) {
                        ?>
                        <ul class="d-block">
                            <li class="menu_title"><a href="category_user.php?subcategory=<?php echo $r['category'] ?>"><?php echo $r['category'] ?></a></li>
                            <?php $category_id = $r['id'];
    ...
    <li><a href="clearance_user.php">Clearance</a></li>
    <li><a href="my_order_user.php">My Orders</a></li>
</ul>
                        </div>
                    </div>
                </div>
        ...
        <!-- Ec Main Menu End -->
                        ...
                        <div class="align-self-center">
                            <div class="ec-header-bottons">
                                ...
                                <a href="wishlist_user.php" class="ec-header-btn ec-header-wishlist">
                                    <div class="header-icon"><i class="fi-rr-heart"></i></div>
                    ...
                    <ul>
                        ...
                        <?php
                                                ...
                                                while ($r = mysqli_fetch_assoc($rider)) {
                                                    ?>
                            <ul class="sub-menu">
                                <li><a href="category_user.php?subcategory=<?php echo $r['category'] ?>"><?php echo $r['category'] ?></a>
                                    <ul class="sub-menu">
                                    <?php $category_id = $r['id'];
                                                $query1 = mysqli_query($con, "SELECT * FROM sub_category WHERE `category_id`='$category_id' AND `type_1` = 'Customer'");
                                                if (mysqli_num_rows($query1) > 0) {
