...
if (isset($_POST['add'])) {
    ...
    $query = "INSERT INTO `category`( `category`,`type`,`type_1` ,`status`) VALUES ('" . $category . "','" . $type . "','".$type_1."','1')";
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE `category` SET `category`='$category',`type_1`='$type_1' WHERE `id`='$id'";
    // echo $query;
												...
												<tr>
													...
													<td>
														<div class="btn-group">
                                                            ...
                                                            <a class="dropdown-item" href="view_subcategory.php?id=<?php echo $q['id']; ?>&category=<?php echo $q['category']; ?>">Sub Category</a>
					...
					<div class="modal fade modal-add-contact" id="modal-add-contact<?php echo $id ?>" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            ...
                            <form class="form-horizontal m-t-30" enctype="multipart/form-data" method="post">
									...
									<?php
									                    $query2=mysqli_query($con,"SELECT * FROM `category` WHERE `id` = '$id'  ") ;
