													...
													<td>
														<div class="btn-group mb-1">
															...
															<div class="dropdown-menu">
                                                                <a href="additional_product.php?product_id=<?php echo $q['product_id'] ?>" class="dropdown-item">Additional Product Images</a>
                                                                <a href="view_color_additional.php?product_id=<?php echo $q['product_id'] ?>" class="dropdown-item">Additional Color Product Images</a>
