...
if (isset($_POST["save"])) {
  ...
  $reg = mysqli_query($con, "SELECT * FROM `sub_category` ") or die(mysqli_error($con));
	...
	$res = $con->query("INSERT INTO `image`(`product_id`,`type_1`,`file`,`color`, `category`, `sub_category`,`size`,`status`) VALUES 
	('" . $product_id . "','".$type_1."','" . $fil . "','" . $color . "','" . $cate . "',
	'" . $sub_cate . "','" . $size . "','1')");
...
// 	$res = $con->query("INSERT INTO `image`(`product_id`,`type_1`,`file`,`color`, `category`,`size`, `sub_category`,`status`) VALUES
//    ('" . $product_id . "','".$type_1."','" . $fil . "','" . $color . "','" . $cate . "','" . $size . "','" . $sub_cate . "','1')");
// 	$count = mysqli_affected_rows($con);
// 	// echo $count;
// 	// die();
...
// 		$count1 = mysqli_affected_rows($con);
  ...
  $qry = mysqli_query($con, "SELECT count(*) as count FROM `product`");
  $_pid_1 = mysqli_fetch_array($qry)['count'];
  $_pid1 = $_pid_1 + 1;
  ?>
<!DOCTYPE html>
			...
			<div class="ec-content-wrapper">
				<div class="content">
					...
					<div class="row">
                      ...
                      <?php
									          $query2=mysqli_query($con,"SELECT * FROM `product` WHERE `product_id` = '$product_id'  ") ;
														$q2=mysqli_fetch_array($query2);
														?>
													<div class="col-md-12">
														<label for="inputEmail4" class="form-label">Customer/Dealer</label>
                            <input type="text" class="form-control slug-title" name="type_1" value="<?php echo $q2['type_1'] ?>" readonly>
													</div>
													<div class="col-md-12">
														<label class="form-label">Product Name</label>
														<input type="text" class="form-control slug-title" name="name" value="<?php echo $q2['name'] ?>" readonly>
													</div>
													<div class="col-md-12">
													...
													<div class="col-md-6">
														...
														<input type="number" class="form-control" name="price" value="<?php echo $q2['price'] ?>" readonly>
													</div>
													<div class="col-md-6">
														<label class="form-label">Dealer Price</label>
														<input type="number" class="form-control" name="dealer_price" value="<?php echo $q2['dealer_price'] ?>" readonly>
													</div>
													<div class="col-md-12">
														<label class="form-label">Description</label>
														<textarea class="form-control" name="description" readonly rows="4"><?php echo $q2['description'] ?></textarea>
													</div>
													<div class="col-md-12">
