...
$c1 = mysqli_fetch_array($color1); // Replace this with your dynamically calculated amount

$cleanedAmount = $c1['total_amount'];
// Clean the amount to remove any unwanted characters
                        ...
                        <div class="ec-checkout-inner">
                                            ...
                                            <form action="#" method="post" id="shippingForm">
                                                ...
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    ...
                                                    <input type="text" id="address" name="address"
                                                        placeholder="House Number And Street" value=""  required/>
                                                </span>
                                                <span class="ec-bill-wrap ec-bill-half">
                                                    <label>Town*</label>
                                                    <input type="text" id="localty" name="localty"
                                                        placeholder="Town" value=""  required/>
                                                </span>

                                                <span class="ec-bill-wrap ec-bill-half">
                                                    <label>Post Code*</label>
                                                    <input type="text" id="pincode" name="pincode" value="" placeholder="Post Code" required/>
                                                </span>

                                                <span class="ec-bill-wrap ec-bill-half">
                                                    <label>Country*</label>
                                                    <input type="text" id="country" name="country" value="" placeholder="Country" required/>
                                                </span>
                                                <span class="ec-bill-wrap ">
                                                    <label>Shipping Address*</label>
                                                    <input type="text" id="shipping_address" name="shipping_address" value="" placeholder="Shipping Address" required/>
                                                </span>
                            ...
                            <form action="charge.php" method="post">
                                ...
                                <span class="ec-check-order-btn">
                                    ...
                                    <input type="submit" class="btn btn-primary" name="submit" id="secondFormSubmitBtn" value="Pay with PayPal">
                                </span>
                            </form>
                            <br>
                            ...
                            <!-- <form method="post" action="https://test.ipg-online.com/connect/gateway/processing">
                                ...
                                <input type="hidden" name="hashExtended" value="<?php //echo createExtendedHash($amount, $otherParam); ?>"/>
                                <input type="hidden" name="storename" value="7250502827"/>
                                <input type="hidden" name="checkoutoption" value="combinedpage"/>
                                <input type="hidden" name="responseFailURL" value="https://equipride.co.uk/cancel.php/<?php //echo $userid ?>"/>
                                <input type="hidden" name="responseSuccessURL" value="https://equipride.co.uk/success.php/<?php //echo $userid ?>"/>
                                <input type="hidden" name="transactionNotificationURL" value="https://www.example.merchant/webshop/transactionNotification"/>
                                <input type="text" name="chargetotal" value="<?php //echo $amount ?>"/>
                                <input type="hidden" name="currency" value="<?php //echo $otherParam ?>"/>
                                <input type="submit" class="btn btn-primary" id="submit" value="PayBy Card" />
                                ...
                                <?php
                                    ...
                                    if (mysqli_num_rows($product_cart) > 0) {
                                        while ($pc = mysqli_fetch_array($product_cart)) {
                                            ...
                                            // Check if we've displayed 3 items, and if so, break out of the loop
                                            if ($count >= 3) {
                                                break;
                                            }
                                            ?>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                    <div class="ec-product-inner">
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-list-desc"><a href="product_details_guest.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>"><?php echo $pc['name'] ?></a></div>
                            <span class="ec-price">
                                <span class="new-price">£<?php echo $pc['price'] ?></span>
                            </span>
                            <div class="ec-pro-option">
