...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE `cart` SET `quantity`='$quantity',`total_amount`='$total_amount',`status` = '0' WHERE `pro_id`='$product_id'";
    mysqli_query($con, $query) or die(mysqli_error($con));
  
  
    //Reduce Qty in Inventory code starts
  
    $query1=mysqli_query($con,"UPDATE stock set quantity = quantity-$quantity WHERE id = '$product_id' ") 
    ...
    ?>
        <script type="text/javascript">
          window.location = "checkout.php?id=<?php echo $id ?>&&product_id=<?php echo $product_id ?>";
        </script>
                                ...
                                <form  method="POST">
                                    <div class="table-content cart-table-content">
                                        <table>
                                            ...
                                            <?php
                $userid = $_SESSION['admin_id'];
                $email = mysqli_query($con, "SELECT * FROM `register_dealer` WHERE `userid` = '$userid'") or die(mysqli_error($con));
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12"><br>
                                                ...
                                                <div class="ec-sb-block-content">
                                                    <div class="ec-cart-summary-bottom">
                                                        <div class="ec-cart-summary">
                                                            ...
                                                            <input type="text" name="amount" class="totalAmount" id="totalAmount" value="">
                                            ...
                                            <div class="ec-cart-update-bottom">
                                                <a href="full_category.php">Continue Shopping</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                    <div class="ec-product-inner">
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>"><?php echo $pc['name'] ?></a></h5>
