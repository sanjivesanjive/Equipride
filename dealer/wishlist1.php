                ...
                <div class="ec-wish-rightside col-lg-12 col-md-12">
                    ...
                    <div class="ec-compare-content">
                        <div class="ec-compare-inner">
                            ...
                            <?php
                                $wishlist = mysqli_query($con, "SELECT * FROM `product` INNER JOIN `wishlist` ON `product`.`product_id` = `wishlist`.`product_id` WHERE `wishlist`.`type` ='Dealer' AND `wishlist`.`userid` = '$userid' ") or die(mysqli_error($con));
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product-left-sidebar.html"><?php echo $w['name'] ?></a></h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product-left-sidebar.html"><?php echo $w['p_name'] ?></a>
                                </h5>
                                <?php 
                                $desc_wislist = mysqli_query($con,"SELECT * FROM `product` INNER JOIN `wishlist` ON `product`.`product_id` = `wishlist`.`product_id` WHERE `wishlist`.`type` ='Dealer' AND `wishlist`.`userid` = '$userid'")or die(mysqli_error($desc_wislist));
                                $dw = mysqli_fetch_array($desc_wislist);
                                ?>
                                <div class="ec-quickview-desc"><?php echo $dw['description'] ?></div>
                                <div class="ec-quickview-price">
                                    <span class="new-price">£<?php echo $dw['price'] ?></span>
                                </div>
