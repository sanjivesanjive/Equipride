                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image" style="height: 300px !important;">
                                                <a href="product_details.php?id=<?php echo $w['id'] ?>&&product_id=<?php echo $w['product_id'] ?>" >
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details.php?id=<?php echo $w['id'] ?>&&product_id=<?php echo $w['product_id'] ?>"><?php echo $w['p_name'] ?></a></h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details.php?id=<?php echo $w['id'] ?>&&product_id=<?php echo $w['product_id'] ?>"><?php echo $w['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <a class="btn btn-primary" href="product_details.php?id=<?php echo $w['id'] ?>&&product_id=<?php echo $w['product_id'] ?>">View Product</a>
