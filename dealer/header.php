                ...
                <div class="row align-items-center">
                    ...
                    <div class="col text-center header-top-center">
                        <div class="header-top-message text-upper">
                            <span>Free Shipping</span>All Over UK
                        </div>
                    </div>
                    ...
                    <div class="col header-top-right d-none d-lg-block">
                        <div class="header-top-lan-curr d-flex justify-content-end">
                            ...
                            <div id="google_translate_dealer"></div>
                                <script type="text/javascript">
                                function googleTranslateElementInit() {
                                new google.translate.TranslateElement({pageLanguage: 'en'}, 'google_translate_dealer');
                                }
                                </script>
                        ...
                        <div class="ec-header-bottons">
                            ...
                            <div class="ec-header-user dropdown">
                                ...
                                <?php 
                                        ...
                                        $wishlist =mysqli_query($con,"SELECT * FROM `admin` WHERE `type` = 'dealer' AND `userid` = '$userid'") or die(mysqli_error($con));
                                        $w = mysqli_fetch_array($wishlist);
                                        ?>
                                        <li><a class="dropdown-item" href="#"><?php echo $w['userid'] ?></a></li>
                                        <li><a class="dropdown-item" href="profile_dealer.php">Profile</a></li>
                                </ul>
                            </div>
                            <!-- Header User End -->
                            <!-- Header Cart Start -->
                            ...
                            <?php 
                                        $userid = $_SESSION['admin_id'];
                                        $cart =mysqli_query($con,"SELECT * FROM `cart` WHERE `userid` = '$userid'") or die(mysqli_error($con));
                                        $c = mysqli_num_rows($cart);
                                        // print_r($w);
                                        ?>
                            <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
                                <div class="header-icon"><i class="fi-rr-shopping-basket"></i></div>
                                <span class="ec-header-count ec-cart-count cart-count-lable"><?php echo $c ?></span>
                            </a>
                            <!-- Header Cart End -->
                            <!-- Header menu Start -->
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="dealer_panal.php"><img src="images/Logo editted.png" alt="Site Logo" /><img
                ...
                <div class="row">
                    <div class="col-md-12 align-self-center">
                        <div class="ec-main-menu">
                            <ul>
                                <li><a href="dealer_panal.php">Home</a></li>
                                <li class="dropdown position-static"><a href="javascript:void(0)">Rider</a>
                                    <ul class="mega-menu d-block" style="position: absolute;width: 322%;left: -100%;">
                                        <li class="d-flex">
                                        <?php
                                                $rider = mysqli_query($con, "SELECT * FROM `category` WHERE `type`='Rider' AND `type_1` = 'Dealer' ") or die(mysqli_error($con));
                                            ...
                                            <ul class="d-block">
                                                ...
                                                $query1 = mysqli_query($con, "SELECT * FROM sub_category WHERE `category_id`='$category_id' AND `type_1` = 'Dealer' AND `type` ='Rider'");
                                                if (mysqli_num_rows($query1) > 0) {
                                                while ($q1 = mysqli_fetch_array($query1)) {
                                                    ?>
                                                <li><a href="category.php?subcategory=<?php echo $q1['sub_category'] ?>"><?php echo $q1['sub_category'] ?></a>
                                                </li>
                                                <?php }} ?>
                                            </ul>
                                            <?php }} ?>
                                ...
                                <li class="dropdown position-static"><a href="javascript:void(0)">Horse</a>
                                    <ul class="mega-menu d-block" style="position: absolute;width: 322%;left: -100%;">
                                        <li class="d-flex">
                                        <?php
                                                $horse = mysqli_query($con, "SELECT * FROM `category` WHERE `type`='Horse' AND `type_1` = 'Dealer' ") or die(mysqli_error($con));
                                            ...
                                            <ul class="d-block">
                                                <li class="menu_title"><a href="javascript:void(0)"><?php echo $r['category'] ?></a></li>
                                                <?php $category_id = $r['id'];
                                                $query1 = mysqli_query($con, "SELECT * FROM sub_category WHERE `category_id`='$category_id' AND `type_1` = 'Dealer' AND `type`='Horse'");
                                                if (mysqli_num_rows($query1) > 0) {
                                                while ($q1 = mysqli_fetch_array($query1)) {
                                                    ?>
                                                <li><a href="category.php?subcategory=<?php echo $q1['sub_category'] ?>"><?php echo $q1['sub_category'] ?></a>
                                ...
                                <li class="dropdown position-static"><a href="javascript:void(0)">DOG</a>
                                    <ul class="mega-menu d-block" style="position: absolute;width: 322%;left: -100%;">
                                        <li class="d-flex">
                                        <?php
                                                $rider = mysqli_query($con, "SELECT * FROM `category` WHERE `type`='Dog' AND `type_1` = 'Dealer' ") or die(mysqli_error($con));
                                                if (mysqli_num_rows($rider) > 0) {
                                                while ($r = mysqli_fetch_array($rider)) {
                                                    ?>
                                            <ul class="d-block">
                                                <li class="menu_title"><a href="category.php?subcategory=<?php echo $r['category'] ?>"><?php echo $r['category'] ?></a></li>
                                                <?php $category_id = $r['id'];
                                                $query1 = mysqli_query($con, "SELECT * FROM sub_category WHERE `category_id`='$category_id' AND `type_1` = 'Dealer'");
                                                if (mysqli_num_rows($query1) > 0) {
                                                while ($q1 = mysqli_fetch_array($query1)) {
                                                    ?>
                                                <li><a href="category.php?subcategory=<?php echo $sc['sub_category'] ?>"><?php echo $q1['sub_category'] ?></a>
                                                </li>
                                                <?php }} ?>
                                            </ul>
                                            <?php }} ?>
                    ...
                    <ul>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    ...
                                    <?php $category_id = $r['id'];
                                                ...
                                                while ($q1 = mysqli_fetch_array($query1)) {
                                                    ?>
                                        <li><a href="category_dealer.php?subcategory=<?php echo $q1['sub_category'] ?>"><?php echo $q1['sub_category'] ?></a></li>
                                        <?php }} ?>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <?php
                                                ...
                                                while ($r = mysqli_fetch_array($rider)) {
                                                    ?>
                            <ul class="sub-menu">
                                <li><a href="category_dealer.php?subcategory=<?php echo $r['category'] ?>"><?php echo $r['category'] ?></a>
                                    <ul class="sub-menu">
                                    <?php $category_id = $r['id'];
                        ...
                        <li><a href="clearance_dealer.php">Clearance</a></li>
                    </ul>
                </div>
