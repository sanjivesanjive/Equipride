                ...
                <div class="ec-shop-rightside col-lg-12 col-md-12">
                    ...
                    <div class="shop-pro-content">
                        <div class="shop-pro-inner">
                            <div class="row">
                            <?php
                                                    $product_full = mysqli_query($con, "SELECT * FROM `product` WHERE `type_1` = 'Dealer' ") or die(mysqli_error($con));
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image" style="height: 238px !important;">
                                                <a href="product_details.php?id=<?php echo $pf['id'] ?>&&product_id=<?php echo $pf['product_id'] ?>" >
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details.php?id=<?php echo $pf['id'] ?>&&product_id=<?php echo $pf['product_id'] ?>"><?php echo $pf['name'] ?></a></h5>
                                            <div class="ec-pro-list-desc"><?php echo $pf['description'] ?></div>
                                            <span class="ec-price">
                                                <span class="new-price">£<?php echo $pf['dealer_price'] ?></span>
                                            </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details.php?id=<?php echo $pf['id'] ?>&&product_id=<?php echo $pf['product_id'] ?>"><?php echo $pf['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <a class="btn btn-primary" href="product_details.php?id=<?php echo $pf['id'] ?>&&product_id=<?php echo $pf['product_id'] ?>">View Product</a>
