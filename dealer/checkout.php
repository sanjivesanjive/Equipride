                                ...
                                <div class="ec-checkout-block ec-check-bill">
                                    ...
                                    <div class="ec-bl-block-content">
                                        ...
                                        <div class="ec-check-bill-form">
                                            <?php 
                                             $color1 = mysqli_query($con, "SELECT * FROM `register_dealer` WHERE `userid` ='$userid'") or die(mysqli_error($con));
                                             $c1 = mysqli_fetch_array($color1);
                                             ?>
                                            <form action="#" method="post">
                                                ...
                                                <span class="ec-bill-wrap">
                                                    ...
                                                    <input type="text" name="address" value="<?php echo $c1['billing_address'] ?>" placeholder="Address Line 1" />
                                                </span>
                                                <span class="ec-bill-wrap">
                                                    <label>Shipping Address</label>
                                                    <input type="text" name="address" value="<?php echo $c1['shipping_address'] ?>" placeholder="Address Line 1" />
                                                </span>
                            ...
                            <div class="ec-sb-block-content">
                                ...
                                <?php 
                                            ...
                                            $pc1 = mysqli_fetch_array($product_cart1);
                                                ?>
                                                                                                        <?php
                                $image = mysqli_query($con, "SELECT * FROM `stock` WHERE  `product_id`='$product_id' AND `type_1`='Dealer'") or die(mysqli_error($con));
                                $i = mysqli_fetch_array($image);
                                ?>
                                <?php
                                    if($i['quantity'] == "0"){
                                        echo 'stock : ' . $i['quantity'] . '
                                        <h4><span class="note">Out of Quantity</span></h4>
                                        <h6><span class="note">Next Update On ' . $i['u_date'] . '</span></h6>';
                                    }else{
                                        echo 'Total Quantity : ' . $pc1['quantity'] . '
                                        <h6><span class="note">Remaning Quantity : ' . $i['quantity'] . '</span></h6>';
                                    }
                                    ?>
                                    <div>
                                        ...
                                        <div class="ec-product-inner">
                                            <div class="ec-pro-image-outer">
                                                <div class="ec-pro-image">
                                                    <a href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['pro_id'] ?>" >
                                            ...
                                            <div class="ec-pro-content">
                                                <h5 class="ec-pro-title"><a href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['pro_id'] ?>"><?php echo $pc['p_name'] ?></a></h5>
    ...
    <section class="section ec-new-product section-space-p">
        <div class="container">
            ...
            <div class="row">
                <!-- New Product Content -->
                <?php 
                                $product_category =  mysqli_query($con, "SELECT * FROM `product` WHERE `type_1`='Dealer' ORDER BY `product`.`id` DESC LIMIT 4;") or die(mysqli_error($con));
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image" style="height: 300px !important;">
                                <a href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>" >
                                    <img class="main-image"
                        ...
                        <div class="ec-pro-content">
                            ...
                            <div class="ec-pro-list-desc"><a href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>"><?php echo $pc['name'] ?></a></div>
                            <span class="ec-price">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>"><?php echo $pc['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <a class="btn btn-primary" href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>">View Product</a>
