...
// echo $user_type_value['type'];

$_SESSION['cancel_message'] = "Payment Canceled!";

// Cancel Message For User

if ($user_type_value['type'] === "user") {
    // Check if the token is set
    if (isset($token)) {
        $sql_payment = "UPDATE orders SET payment_status='Canceled', payment_method='PayPal' WHERE userid='$userid' AND orderid='$orderid'";
