                                ...
                                <ul>
                                    <li>
                                        <div class="ec-sidebar-block-item">
                                            <input type="checkbox" checked /> <a href="category_get_guest.php?subcategory=<?php echo $c['sub_category'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $c['sub_category'] ?><span></span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_get_guest.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>&&guest_id=<?php echo $userid; ?>">Handbag leather purse for
                                        women</a>
                                </h5>
