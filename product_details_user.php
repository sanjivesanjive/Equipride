...
if (isset($_POST["cart"])) {
    ...
    if ($result) {
        ...
        header("Location: cart_user.php?id=$id&product_id=$product_id&user_id=$userid"); // You can customize the success page URL
                    ...
                    <div class="row ec_breadcrumb_inner">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="user_panal.php?user_id=<?php echo $userid; ?>">Home</a></li>
                                ...
                                <div class="single-pro-desc single-pro-desc-no-sidebar">
                                    <div class="single-pro-content">
                                        ...
                                        <div class="ec-pro-variation">
                                            <div class="">
                                                <span id="colorParagraph">Please Choose Colour</span>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image" style="height: 300px !important;">
                                <a href="product_details_user.php?id=<?php echo $p['id'] ?>&&product_id=<?php echo $p['product_id'] ?>&&user_id=<?php echo $userid; ?>" >
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product_details_user.php?id=<?php echo $p['id'] ?>&&product_id=<?php echo $p['product_id'] ?>&&user_id=<?php echo $userid; ?>"><?php echo $p['name'] ?></a></h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_user.php?id=<?php echo $pd['id'] ?>&&product_id=<?php echo $pd['product_id'] ?>&&user_id=<?php echo $userid; ?>"><?php echo $pd['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <a class="btn btn-primary" href="product_details_user.php?id=<?php echo $pd['id'] ?>&&product_id=<?php echo $pd['product_id'] ?>&&user_id=<?php echo $userid; ?>">View Product</a>
...
// var src1 = $(".slick-slide.slick-cloned.slick-active .img-responsive").attr("src");
// var slickActiveElement = $(".slick-slide.slick-active");
...
<script>
    ...
    // Set the first option in the size select as the default selection
