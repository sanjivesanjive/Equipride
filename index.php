...
<body>
                                    ...
                                    while ($r = mysqli_fetch_array($rider)) {
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product_details.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>" >
                                    ...
                                    while ($h = mysqli_fetch_array($horse)) {
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product_details.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>" >
                                    ...
                                    while ($c = mysqli_fetch_array($clearance)) {
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                            <div class="ec-product-inner">
                                                <div class="ec-pro-image-outer">
                                                    <div class="ec-pro-image">
                                                        <a href="product_details.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>" >
                    ...
                    while ($np = mysqli_fetch_array($new_product)) {
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                            <div class="ec-product-inner">
                                <div class="ec-pro-image-outer">
                                    <div class="ec-pro-image">
                                        <a href="product_details.php?id=<?php echo $np['id'] ?>&&product_id=<?php echo $np['product_id'] ?>" >
    ...
    <div class="ec-cart-float" style="bottom:150px !important">
