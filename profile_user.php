...
if (isset($_POST['update'])) {
    ...
    // die();
    $res = $con->query("UPDATE `register` SET `name`='$name',`dob`='$dob',`email`='$email',`phone` = '$phone',`pincode` = '$pincode',
    `localty` = '$localty',`country` = '$country',`address`='$billing_address',`shipping_address`='$shipping_address',`image` = '$fil' WHERE `userid`='$userid'");
                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">User Settings</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="user_panal.php">Home</a></li>
                                <li class="ec-breadcrumb-item active">User Settings</li>
                            </ul>
    ...
    <section class="ec-page-content ec-vendor-uploads section-space-p">
        <div class="container">
            <div class="row">
                        ...
                        <div class="ec-sidebar-block">
                            <div class="ec-vendor-block">
                                <div class="ec-vendor-block-items">
                                    <ul>
                                        <li><a href="profile_user.php">User Profile</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <?php 
                    $dealer = mysqli_query($con,"SELECT * FROM `register` WHERE `userid` = '$userid'")or die(mysqli_error($dealer));
