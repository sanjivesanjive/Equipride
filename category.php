                ...
                <div class="ec-shop-rightside col-lg-12 col-md-12">
                    ...
                    <div class="shop-pro-content">
                        <div class="shop-pro-inner">
                            <div class="row">
                            <?php 
                                $product_category =  mysqli_query($con, "SELECT * FROM `product` WHERE  `sub_category`='$sub_category' AND `type_1`='Customer'") or die(mysqli_error($con));
                                ...
                                <ul>
                                    <li>
                                        <div class="ec-sidebar-block-item">
                                            <input type="checkbox" checked /> <a href="category.php?subcategory=<?php echo $c['sub_category'] ?>"><?php echo $c['sub_category'] ?><span></span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>">Handbag leather purse for
                                        women</a>
                                </h5>
