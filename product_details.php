                                ...
                                <div class="single-pro-desc single-pro-desc-no-sidebar">
                                    <div class="single-pro-content">
                                        ...
                                        <div class="qty-plus-minus">
                                            ...
                                            <a href="login.php?id=<?php //echo $id; ?>&product_id=<?php //echo $product_id; ?>" style="color:#ffffff !important;">Add To Cart</a>
                                        </button>
                                             ...
                                             <button class="btn btn-primary" id="addToCartButton">
                                                <a id="addToCartLink" style="color:#ffffff !important;">Add To Cart</a>
                                            </button>
                                            </div> 
...
<script>
    ...
    function resetFormInputs() {
        $(".selected_color").removeClass('active');
        $("#category-dropdown").val('');
        $("#qty-input-num").val(1);
    }

    // Add an event listener to the "Add to Cart" button click
    $(".ec-single-cart button").click(function (event) {
        var colorChecked = false;
        var sizeSelected = $("#category-dropdown").val();
        var valSelected = $("#qty-input-num").val();

        if ($(".selected_color.active").length > 0) {
            colorChecked = true;
        }
...
<script>
    // JavaScript code to update the link's href
    $(document).ready(function () {
        var addToCartLink = $("#addToCartLink");
        var imageSrc = "<?php echo basename($imageSrc); ?>";
        var productName = "<?php echo $pd['name']; ?>";
        var productPrice = "<?php echo $pd['price']; ?>";
        ...
        $("#addToCartButton").click(function () {
            ...
            var url = "login.php?id=<?php echo $id; ?>&product_id=" + productID +
                      "&product_image=" + encodeURIComponent(imageSrc) +
...
// For Image Change
          if (colorValue === "Red") {
            $("#displayedImage").attr("src", "red.jpg");
            $("#displayedImage2").attr("src", "red.jpg");
            $(".zoomImg").attr("src", "red.jpg");
