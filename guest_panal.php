...
if (isset($_SESSION['cancel_message'])) {
    ...
    // Clear the cancel message to prevent it from showing again
...
if (isset($_SESSION['success_message'])) {
    ...
    // Clear the success message to prevent it from showing again
...
<head>
    ...
    <!-- Include jQuery (required by Alertify) -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <link rel="preload" as="script" href="https://salesiq.zoho.in/widget" />

</head>
<style>
    
        /* CSS to style the alert messages */
        .alertify-notifier.ajs-right .ajs-message.ajs-success {
...
<body>
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image" >
                                                <a href="product_details_guest.php?id=<?php echo $p['id'] ?>&&product_id=<?php echo $p['product_id'] ?>" >
                                                ...
                                                <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            ...
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_guest.php?id=<?php echo $p['id']?>&product_id=<?php echo $p['product_id']?>" class="add-to-cart" id="addToCartButton">
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details_guest.php?id=<?php echo $p['id'] ?>&&product_id=<?php echo $p['product_id'] ?>"><?php echo $p['name'] ?></a></h5>
                                            <span class="ec-price">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <a class="btn btn-primary" href="product_details_guest.php?id=<?php echo $p['id'] ?>&&product_id=<?php echo $p['product_id'] ?>">View Product</a>
    ...
    <!-- Modal end -->
                                <?php }} ?>
                                <div class="col-sm-12 shop-all-btn"><a href="full_category_guest.php">Shop All
                                        Collection</a></div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product_details_guest.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>" >
                                                ...
                                                <!-- <a href="#" class="quickview" data-link-action="quickview"
                                                    ...
                                                    <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            ...
                                                            data-bs-target="#ec_quickview_modal<?php echo $r['product_id'] ?>"><i class="fi-rr-eye"></i></a>
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_guest.php?id=<?php echo $r['id']?>&product_id=<?php echo $r['product_id']?>" class="add-to-cart" id="addToCartButton">
                                                                <i class="fi-rr-shopping-basket"></i> Add To Cart
                                                            </a>
                                                                    <br>
                                                                    <form method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <button title="Wishlist" class="ec-btn-group wishlist" data-productid="<?php echo $r['product_id']; ?>" data-userid="<?php echo $userid; ?>"><i class="fi-rr-heart"></i></button>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details_guest.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>"><?php echo $r['name'] ?></a></h5>
                                            <span class="ec-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_guest.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>"><?php echo $r['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                    <a class="btn btn-primary" href="product_details_guest.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>">View Product</a>
                                        <!-- <button class="btn btn-primary">Add To Cart</button> -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product_details_guest.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>" >
                                                ...
                                                <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            ...
                                                            data-bs-target="#ec_quickview_modal<?php echo $main_id ?>"><i class="fi-rr-eye"></i></a>
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_guest.php?id=<?php echo $h['id']?>&product_id=<?php echo $h['product_id']?>" class="add-to-cart" id="addToCartButton">
                                                                <i class="fi-rr-shopping-basket"></i> Add To Cart
                                                            </a>
                                                                    <br>
                                                                    <form method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <button title="Wishlist" class="ec-btn-group wishlist" data-productid="<?php echo $h['product_id']; ?>" data-userid="<?php echo $userid; ?>"><i class="fi-rr-heart"></i></button>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details_guest.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>"><?php echo $h['name'] ?></a></h5>
                                            <span class="ec-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_guest.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>"><?php echo $h['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                    <a class="btn btn-primary" href="product_details_guest.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>">View Product</a>
                                        <!-- <button class="btn btn-primary">Add To Cart</button> -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product_details_guest.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>" >
                                                ...
                                                <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            ...
                                                            data-bs-target="#ec_quickview_modal<?php echo $main_id ?>"><i class="fi-rr-eye"></i></a>
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_guest.php?id=<?php echo $c['id']?>&product_id=<?php echo $c['product_id']?>" class="add-to-cart" id="addToCartButton">
                                                                <i class="fi-rr-shopping-basket"></i> Add To Cart
                                                            </a>
                                                                    <br>
                                                                    <form method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <button title="Wishlist" class="ec-btn-group wishlist" data-productid="<?php echo $c['product_id']; ?>" data-userid="<?php echo $userid; ?>"><i class="fi-rr-heart"></i></button>
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details_guest.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>"><?php echo $c['name'] ?></a></h5>
                                            <span class="ec-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_guest.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>"><?php echo $c['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                    <a class="btn btn-primary" href="product_details_guest.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>">View Product</a>
                                        <!-- <button class="btn btn-primary">Add To Cart</button> -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product_details_guest.php?id=<?php echo $np['id'] ?>&&product_id=<?php echo $np['product_id'] ?>" >
                                ...
                                <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            ...
                                                            data-bs-target="#ec_quickview_modal<?php echo $main_id ?>"><i class="fi-rr-eye"></i></a>
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_guest.php?id=<?php echo $np['id']?>&product_id=<?php echo $np['product_id']?>" class="add-to-cart" id="addToCartButton">
                                                                <i class="fi-rr-shopping-basket"></i> Add To Cart
                                                            </a>
                                                                    <br>
                                                                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product_details_guest.php?id=<?php echo $np['id'] ?>&&product_id=<?php echo $np['product_id'] ?>"><?php echo $np['name'] ?></a>
                            </h5>
                            <span class="ec-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_guest.php?id=<?php echo $np['id'] ?>&&product_id=<?php echo $np['product_id'] ?>"><?php echo $np['name'] ?></a>
                                </h5>
    ...
    <!-- Modal end -->
    <?php }} ?>
                <div class="col-sm-12 shop-all-btn"><a href="full_category_guest.php">Shop All Collection</a>
                </div>
            </div>
        </div>
    </section>
...
<script src="path-to-alertify/alertify.min.js"></script>

<script>
        $(document).ready(function() {
            // Check if there's a cancel message
            var cancelMessage = "<?php echo isset($cancel_message) ? $cancel_message : '' ?>";

            // Check if there's a success message
            var successMessage = "<?php echo isset($success_message) ? $success_message : '' ?>";
            alertify.set('notifier', 'position', 'top-right');

            // Show Alertify alert for cancel_message
            if (cancelMessage) {
                alertify.error(cancelMessage);
                $('.ajs-message.ajs-error').css('color', 'white');
            }

            // Show Alertify alert for success_message
            if (successMessage) {
                alertify.success(successMessage);
                $('.ajs-message.ajs-success').css('color', 'white');
            }
        });
    </script>
