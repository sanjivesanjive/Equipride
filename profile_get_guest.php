...
if (isset($_POST['update'])) {
    ...
    // die();
    $res = $con->query("UPDATE `guest` SET `name`='$name',`dob`='$dob',`email`='$email',`phone` = '$phone',`pincode` = '$pincode',`localty` = '$localty',
    `country`= '$country',`address`='$billing_address',`shipping_address`='$shipping_address',`image` = '$fil' WHERE `userid`='$userid'");
    $count = mysqli_affected_rows($con);
    ?>
    <script type="text/javascript">
      // alert("Technician updated successsfully")
      window.location = "profile_get_guest.php?guest_id=<?php echo $userid; ?>"
    </script>
    <?php
  ...
  if ($count > 0) {
    ...
    header("location:profile_get_guest.php?guest_id=<?php echo $userid; ?>");
  }
                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">Guest Settings</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="guest_get_panal.php?guest_id=<?php echo $userid; ?>">Home</a></li>
                                <li class="ec-breadcrumb-item active">Guest Settings</li>
                            </ul>
    ...
    <section class="ec-page-content ec-vendor-uploads section-space-p">
        <div class="container">
            <div class="row">
                        ...
                        <div class="ec-sidebar-block">
                            <div class="ec-vendor-block">
                                <div class="ec-vendor-block-items">
                                    <ul>
                                        <li><a href="profile_get_guest.php?guest_id=<?php echo $userid; ?>">Guest Profile</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <?php 
                    $dealer = mysqli_query($con,"SELECT * FROM `guest` WHERE `userid` = '$userid'")or die(mysqli_error($dealer));
