				...
				<div class="content">
					<div class="breadcrumb-wrapper breadcrumb-wrapper-2">
						...
						<p class="breadcrumbs"><span><a href="dashboard.php">Home</a></span>
							<span><i class="mdi mdi-chevron-right"></i></span>Payment History
						</p>
					</div>
					<div class="row">
						<div class="col-12">
										...
										<table id="responsive-data-table" class="table" style="width:100%">
                                            ...
                                            <?php
												...
												<tr>
													...
													<td><?php echo $q['payment_id'] ?></td>
													<td><?php echo $q['payer_id'] ?></td>
													<td><?php echo $q['payer_email'] ?></td>
													<td><?php echo $q['amount'] ?></td>
													<td><?php echo $q['currency'] ?></td>
													<td><span class="mb-2 mr-2 badge badge-secondary"><?php echo $q['payment_status'] ?></span></td>
												</tr>
                                                <?php }} ?>
											</tbody>
										</table>
