...
if (isset($_POST['register'])) {
    ...
    Name '.$_POST['name'].'
     ...
     Adderes  '.$_POST['address'].'
      ';
    $message1 = 'we will contact you shortly';

    $headers = "from:" . $from;
    $headers2 = "from:" . $to;
    mail($to,$subject,$message,$headers);
    mail($from,$subject2,$message1); // sends a copy of the message to the sender
                    ...
                    <div class="row ec_breadcrumb_inner">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <ul class="ec-breadcrumb-list">
                                ...
                                <li class="ec-breadcrumb-item active">Register As Dealer</li>
                            </ul>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Register As Dealer</h2>
                        <h2 class="ec-title">Register As Dealer</h2>
