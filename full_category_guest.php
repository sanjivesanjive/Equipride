                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image" style="height: 238px !important;">
                                                <a href="product_details_guest.php?id=<?php echo $pf['id'] ?>&&product_id=<?php echo $pf['product_id'] ?>" >
                                                ...
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    ...
                                                    <!-- <a href="compare.html" class="ec-btn-group compare"
                                                        ...
                                                        <a title="Add To Cart" href="product_details_guest.php?id=<?php echo $pf['id']?>&product_id=<?php echo $pf['product_id']?>" class="add-to-cart" id="addToCartButton">
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details_guest.php?id=<?php echo $pf['id'] ?>&&product_id=<?php echo $pf['product_id'] ?>"><?php echo $pf['name'] ?></a></h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_guest.php?id=<?php echo $pf['id'] ?>&&product_id=<?php echo $pf['product_id'] ?>"><?php echo $pf['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <a class="btn btn-primary" href="product_details_guest_guest.php?id=<?php echo $pf['id'] ?>&&product_id=<?php echo $pf['product_id'] ?>">View Product</a>
