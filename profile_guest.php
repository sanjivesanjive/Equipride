...
if (isset($_POST['update'])) {
    ...
    `country`= '$country',
    `address`='$billing_address',`shipping_address`='$shipping_address',`image` = '$fil' WHERE `userid`='$userid'");
    $count = mysqli_affected_rows($con);
    ?>
    <script type="text/javascript">
      // alert("Technician updated successsfully")
      window.location = "profile_guest.php"
    </script>
    <?php
  ...
  if ($count > 0) {
    ...
    header("location:profile_guest.php");
  }
                        ...
                        <div class="ec-sidebar-block">
                            <div class="ec-vendor-block">
                                <div class="ec-vendor-block-items">
                                    <ul>
                                        <li><a href="profile_guest.php">User Profile</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
