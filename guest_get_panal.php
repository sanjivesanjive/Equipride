...
<body>
                                ...
                                <li>
                                    ...
                                    <?php
                                                    ...
                                                    while ($sc = mysqli_fetch_array($scategory)) {
                                                        ?>
                                        <li>
                                            <div class="ec-sidebar-sub-item"><a href="category.php?subcategory=<?php echo $sc['sub_category'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $sc['sub_category'] ?><span
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details.php?id=<?php echo $p['id'] ?>&&product_id=<?php echo $p['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $p['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <a class="btn btn-primary" href="product_details_get_guest.php?id=<?php echo $p['id'] ?>&&product_id=<?php echo $p['product_id'] ?>&&guest_id=<?php echo $userid; ?>">View Product</a>
    ...
    <!-- Modal end -->
                                <?php }} ?>
                                <div class="col-sm-12 shop-all-btn"><a href="full_category_get_guest.php?guest_id=<?php echo $userid; ?>">Shop All
                                        Collection</a></div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product_details_get_guest.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>&&guest_id=<?php echo $userid; ?>" >
                                                ...
                                                <!-- <a href="#" class="quickview" data-link-action="quickview"
                                                    ...
                                                    <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            ...
                                                            data-bs-target="#ec_quickview_modal<?php echo $r['product_id'] ?>"><i class="fi-rr-eye"></i></a>
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_get_guest.php?id=<?php echo $r['id']?>&product_id=<?php echo $r['product_id']?>" class="add-to-cart" id="addToCartButton">
                                                                <i class="fi-rr-shopping-basket"></i> Add To Cart
                                                            </a>
                                                                    <br>
                                                                    <form method="POST" enctype="multipart/form-data" >
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details_get_guest.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $r['name'] ?></a></h5>
                                            <span class="ec-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_get_guest.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $r['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                    <a class="btn btn-primary" href="product_details_get_guest.php?id=<?php echo $r['id'] ?>&&product_id=<?php echo $r['product_id'] ?>&&guest_id=<?php echo $userid; ?>">View Product</a>
                                        <!-- <button class="btn btn-primary">Add To Cart</button> -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product_details_get_guest.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>&&guest_id=<?php echo $userid; ?>" >
                                                ...
                                                <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            ...
                                                            data-bs-target="#ec_quickview_modal<?php echo $main_id ?>"><i class="fi-rr-eye"></i></a>
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_get_guest.php?id=<?php echo $h['id']?>&product_id=<?php echo $h['product_id']?>" class="add-to-cart" id="addToCartButton">
                                                                <i class="fi-rr-shopping-basket"></i> Add To Cart
                                                            </a>
                                                                    <br>
                                                                    <form method="POST" enctype="multipart/form-data" >
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details_get_guest.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $h['name'] ?></a></h5>
                                            <span class="ec-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_get_guest.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $h['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                    <a class="btn btn-primary" href="product_details_get_guest.php?id=<?php echo $h['id'] ?>&&product_id=<?php echo $h['product_id'] ?>&&guest_id=<?php echo $userid; ?>">View Product</a>
                                        <!-- <button class="btn btn-primary">Add To Cart</button> -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product_details_get_guest.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>&&guest_id=<?php echo $userid; ?>" >
                                                ...
                                                <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            ...
                                                            data-bs-target="#ec_quickview_modal<?php echo $main_id ?>"><i class="fi-rr-eye"></i></a>
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_get_guest.php?id=<?php echo $c['id']?>&product_id=<?php echo $c['product_id']?>" class="add-to-cart" id="addToCartButton">
                                                                <i class="fi-rr-shopping-basket"></i> Add To Cart
                                                            </a>
                                                                    <br>
                                                                    <form method="POST" enctype="multipart/form-data" >
                                        ...
                                        <div class="ec-pro-content">
                                            <h5 class="ec-pro-title"><a href="product_details_get_guest.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $c['name'] ?></a></h5>
                                            <span class="ec-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_get_guest.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $c['name'] ?></a></h5>
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                    <a class="btn btn-primary" href="product_details_get_guest.php?id=<?php echo $c['id'] ?>&&product_id=<?php echo $c['product_id'] ?>&&guest_id=<?php echo $userid; ?>">View Product</a>
                                        <!-- <button class="btn btn-primary">Add To Cart</button> -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="ec-fre-section col-lg-6 col-md-6 col-sm-6 margin-b-30" data-animation="slideInRight">
                    <div class="col-md-12 text-left">
                        <div class="section-title">
                            <h2 class="ec-bg-title">coming Soon</h2>
                            ...
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="comming_soon.php?id=<?php echo $cs['id'] ?>&&guest_id=<?php echo $userid; ?>" class="image"><img class="main-image"
                                ...
                                <div class="ec-fs-pro-content col-lg-6 col-md-6 col-sm-6">
                                    <h5 class="ec-fs-pro-title"><a href="comming_soon.php?id=<?php echo $cs['id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $cs['name'] ?></a>
                                    </h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="comming_soon.php?id=<?php echo $cs['id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $cs['name'] ?></a>
                                </h5>
                    ...
                    <?php
                        ...
                        <div class="ec-fs-product">
                            <div class="ec-fs-pro-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="clearance.php?id=<?php echo $cl['id'] ?>&&product_id=<?php echo $cl['product_id'] ?>&&guest_id=<?php echo $userid; ?>" class="image"><img class="main-image"
                                ...
                                <div class="ec-fs-pro-content col-lg-6 col-md-6 col-sm-6">
                                    <h5 class="ec-fs-pro-title"><a href="clearance.php?id=<?php echo $cl['id'] ?>&&product_id=<?php echo $cl['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $cl['name'] ?></a>
                                    </h5>
                                    <div class="ec-fs-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="clearance.php?id=<?php echo $cl['id'] ?>&&product_id=<?php echo $cl['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $cl['name'] ?></a>
                                </h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product_details_get_guest.php?id=<?php echo $np['id'] ?>&&product_id=<?php echo $np['product_id'] ?>&&guest_id=<?php echo $userid; ?>" >
                                    <img class="main-image" src="admin/file/<?php echo $np['file'] ?>" alt="Product" style="height: 322px !important;width: 290px !important;"/>
                                    <!-- <img class="hover-image" src="admin/file/<?php echo $np['file'] ?>" alt="Product" style="height: 322px !important;width: 290px !important;"/> -->
                                </a>
                                <div class="ec-pro-actions">
                                                        <a href="#" class="quickview" data-link-action="quickview"
                                                            title="Quick view" data-bs-toggle="modal"
                                                            data-bs-target="#ec_quickview_modal<?php echo $main_id ?>"><i class="fi-rr-eye"></i></a>
                                                            <br>
                                                            <a title="Add To Cart" href="product_details_get_guest.php?id=<?php echo $np['id']?>&product_id=<?php echo $np['product_id']?>" class="add-to-cart" id="addToCartButton">
                                                                <i class="fi-rr-shopping-basket"></i> Add To Cart
                                                            </a>
                                                                    <br>
                                                                    <form method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title"><a href="product_details_get_guest.php?id=<?php echo $np['id'] ?>&&product_id=<?php echo $np['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $np['name'] ?></a>
                            </h5>
                            <span class="ec-price">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="quickview-pro-content">
                                <h5 class="ec-quick-title"><a href="product_details_get_guest.php?id=<?php echo $np['id'] ?>&&product_id=<?php echo $np['product_id'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $np['name'] ?></a>
                                </h5>
    ...
    <!-- Modal end -->
    <?php }} ?>
                <div class="col-sm-12 shop-all-btn"><a href="full_category.php?guest_id=<?php echo $userid; ?>">Shop All Collection</a>
                </div>
            </div>
        </div>
    </section>
