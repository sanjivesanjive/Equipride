                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">Privacy Statement</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="user_panal.php">Home</a></li>
                                <li class="ec-breadcrumb-item active">Privacy Statement</li>
                            </ul>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        ...
                        <h2 class="ec-title">PRIVACY STAEMENT</h2>
                ...
                <div class="col-md-12">
					...
					<div class="col-sm-12 ec-cms-block">
                        ...
                        <div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
                                <b><h5 class="ec-cms-block-title">SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?</h5></b>
                                <p> We do not store credit card details nor do we share customer details with any 3rd parties.</p>
                            </div>
                        </div>
                        <div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
                               <b> <h5 class="ec-cms-block-title">SECTION 2 - CONSENT</h5></b>
						...
						<div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
							<p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting using the contact options on the Contact page or mailing us at:</p>
							</div>
							</div>
							<div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
							<p>Equipride Ltd Unit 1 Acaster Properties, Cowper Lane, York, YO23 2TX, United Kingdom</p>
							</div></div>
							<div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
							<b> <h5 class="ec-cms-block-title">SECTION 3 - DISCLOSURE</h5></b>
							<p>We may disclose your personal information if we are required by law to do so or if you violate our Terms of Service.</p>
							</div></div>
							<div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
							<b> <h5 class="ec-cms-block-title">SECTION 4 - PAYMENT</h5></b>
							<p>If you choose a direct payment gateway to complete your purchase, your credit card data is encrypted through the Payment Card Industry Data Security Standard (PCI-DSS). Your purchase transaction data is stored only as long as is necessary to complete your purchase transaction. After that is complete, your purchase transaction information is deleted.
</p>
                               </div></div>
							 <div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">							
							...
							<div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
							<b> <h5 class="ec-cms-block-title">SECTION 5 - THIRD-PARTY SERVICES</h5></b>
							...
							<div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
							<b> <h5 class="ec-cms-block-title">SECTION 6 - SECURITY</h5></b>
							<p>To protect your personal information, we take reasonable precautions and follow industry best practices to make sure it is not inappropriately lost, misused, accessed, disclosed, altered or destroyed.</p>
							</div></div>
							<div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
						 <b><h5 class="ec-cms-block-title">SECTION 7 - AGE OF CONSENT</h5></b>
						 <p>By using this site, you represent that you are at least the age of majority in your state or province of residence, or that you are the age of majority in your state or province of residence and you have given us your consent to allow any of your minor dependents to use this site.</p>
						 </div></div>
						 <div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
							<b><h5 class="ec-cms-block-title">SECTION 8 - CHANGES TO THIS PRIVACY POLICY</h5></b>
							...
							<p>If our store is acquired or merged with another company, your information may be transferred to the new owners so that we may continue to sell products to you.</p>
							 ...
							 <div class="col-sm-12 ec-cms-block">
                            <div class="ec-cms-block-inner">
							<b> <h5 class="ec-cms-block-title">QUESTIONS AND CONTACT INFORMATION</h5></b>
