                        ...
                        <div class="ec-header-bottons">
                            ...
                            <div class="ec-header-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a class="dropdown-item" href="register_dealer.php">Become a Dealer</a></li>
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="index.php"><img src="images/Logo editted.png" alt="Site Logo" /><img
                                        ...
                                        <?php
                                            ...
                                            <ul class="d-block">
                                                ...
                                                while ($q1 = mysqli_fetch_array($query1)) {
                                                    ?>
                                                <li><a href="category.php?subcategory=<?php echo $q1['sub_category'] ?>"><?php echo $q1['sub_category'] ?></a></li>
                                                <?php }} ?>
                                            </ul>
                                            <?php }} ?>
                                        </li>
