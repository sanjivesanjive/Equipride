                ...
                <div class="ec-shop-rightside col-lg-12 col-md-12">
                    ...
                    <div class="shop-pro-content">
                        <div class="shop-pro-inner">
                            <div class="row">
                            <?php 
                                $product_category =  mysqli_query($con, "SELECT * FROM `product` WHERE `type_1`='Dealer' AND `clearance_status`='salenow' ") or die(mysqli_error($con));
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image" style="height: 363px !important;">
                                                <a href="product_details.php?id=<?php echo $pc['id'] ?>&&product_id=<?php echo $pc['product_id'] ?>" class="image">
                                                ...
                                                <div class="ec-pro-actions">
                                                    <button title="Add To Cart" class="add-to-cart"><i
                                                            ...
                                                            <form method="POST" enctype="multipart/form-data" >
                                                                ...
                                                                <input type="hidden" name="price" value="<?php echo $pg['dealer_price'] ?>">
                ...
                <div class="ec-shop-leftside filter-sidebar">
                    ...
                    <div class="ec-sidebar-wrap">
                        ...
                        <div class="ec-sidebar-block">
                            ...
                            <?php
                                                    $category = mysqli_query($con, "SELECT * FROM `product` WHERE `type_1` = 'Dealer'  GROUP BY `sub_category`") or die(mysqli_error($con));
