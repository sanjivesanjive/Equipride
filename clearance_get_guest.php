...
// $sub_category_get_guest = $_GET['subcategory_get_guest'];
                                ...
                                <ul>
                                    <li>
                                        <div class="ec-sidebar-block-item">
                                            <input type="checkbox" checked /> <a href="category_get_guest.php?subcategory=<?php echo $c['sub_category'] ?>&&guest_id=<?php echo $userid; ?>"><?php echo $c['sub_category'] ?></a><span></span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
